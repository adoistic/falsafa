...
chapter_number: 112
chapter_title: § 1. Each Form of Index Number for Prices implies a Correlative Form of Index Number for Quantities
chapter_slug: "112-1-each-form-of-index-number-for-prices-implies-a-c"
variant_id: "e42a6afc-8446-5df8-bd19-bc8a2c93db4e"
...
Hence, given a particular formula for P1, we have a resultant and particular formula for T1. For instance, if P1 is a Edition: current; Page: [386] simple arithmetic average of, i.e. if, (formula 3 of the table), where n is the number of commodities of which the price ratios are included, then the correlative formula for T1 will evidently be
...
Thus we may convert Sp1Q1 into either P1T1 or A1Q1. In the first, the p's are represented by a ratio, P1; in the second, Edition: current; Page: [388] by a value, A1; in the first, the Q's are represented by a value, T1; in the second, by a ratio, Q1. The asymmetry of each of the two formulæ P1T1 and A1Q1 is the reverse of the other.
...
It is, therefore, only necessary to show (in accordance with the most general definition of an Edition: current; Page: [389] average as given in the Appendix to Chapter II) that expression (2) shall be equal to k when
...
We conclude that if either Edition: current; Page: [390] P1 or Q1 in the formula
