...
chapter_number: 37
chapter_title: Analogy to the Theory of the Lever.
chapter_slug: "37-analogy-to-the-theory-of-the-lever"
variant_id: "33202960-c5b0-52eb-a6b6-ef2b9561137c"
...
"Let AB be a lever turning freely about C, the fulcrum, and let P be the force applied at A, and W the force exerted, or resistance overcome, or weight Edition: current; Page: [103] raised at B. Suppose the lever turned through the angle ACA', then the work done by P equals P × are AA', and work done by W equals W × arc BB', if P and W act perpendicularly to the arm. Therefore, by the law of energy,
...
Now in statical problems no such process as integration is applicable. The equation lies actually Edition: current; Page: [106] between imaginary infinitesimal quantities, and there is no effect to be summed up. Yet there is no statical problem which is not subject to the principle of virtual velocities, and Poisson, in his Traité de Mécanique,

which commences with statical theorems, asserts explicitly, "Dans cet ouvrage, j'emploierai exclusivement la méthode des infiniment petits."
