...
1. As in the previous questions, so in the present one, we must assume some principle for informing the arguments which are to reveal the truth. For of what avail is it to labor even in speaking truth, if one have no basic principle? And the principle is the sole root of the assumptions, which are the mediums of proof.
