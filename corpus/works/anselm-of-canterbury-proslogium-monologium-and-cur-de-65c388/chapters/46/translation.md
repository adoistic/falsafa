...
chapter_slug: 46
variant_id: "69f107d3-fca9-58b9-ab7c-18c97a298fd6"
...
That this Nature, then, without which no nature exists, is nothing, is as false as it would be absurd to say that whatever is is nothing. And, moreover, it does not exist through nothing, because it is utterly inconceivable that what is something should exist through nothing. But, if in any way it derives existence from nothing, it does so through itself, or through another, or through nothing. But it is evident that Edition: current; Page: [48] in no wise does anything exist through nothing. If, then, in any way it derives existence from nothing, it does so either through itself or through another.
