...
The three *varnas* of the twice-born, abiding in their own duties, may study; but a Brāhmaṇa alone should teach them, not the other two; this is the decision. // Mn_10.1 //

A Brāhmaṇa should know the means of livelihood for all, according to the rule; he should declare them to the others, and he himself should act accordingly. // Mn_10.2 //

On account of his pre-eminence, the excellence of his origin, his observance of the rules, and the distinction of his consecrating rites, the Brāhmaṇa is the lord of the *varnas*. // Mn_10.3 //

The Brāhmaṇa, the Kṣatriya, and the Vaiśya are the three twice-born *varnas*; but the fourth, the Śūdra, is of a single birth; there is no fifth. // Mn_10.4 //
...
From a Brāhmaṇa on a Vaiśya maiden, a son named `Ambaṣṭha` is born; on a Śūdra maiden, a `Niṣāda`, who is also called a `Pāraśava`. // Mn_10.8 //

From a Kṣatriya on a Śūdra maiden is born a creature named `Ugra`, of cruel conduct and habits, having the nature of a Kṣatriya and a Śūdra. // Mn_10.9 //

From a Brāhmaṇa on women of the three *varnas*, from a king on women of two *varnas*, and from a Vaiśya on a woman of one *varna*—these six are remembered as base-born. // Mn_10.10 //

From a Kṣatriya on a Brāhmaṇa maiden is born by caste a `Sūta`; from a Vaiśya, a `Māgadha` and a `Vaideha`, sons of a Kṣatriya and a Brāhmaṇa woman respectively. // Mn_10.11 //

From a Śūdra on Vaiśya, Kṣatriya, and Brāhmaṇa women are born these mixed castes: the `Āyogava`, the `Kṣattṛ`, and the `Caṇḍāla`, the lowest of men. // Mn_10.12 //
...
From a Brāhmaṇa on an `Ugra` maiden is born one named `Āvṛta`; on an `Ambaṣṭha` maiden, an `Ābhīra`; but on an `Āyogavī` maiden, a `Dhigvaṇa`. // Mn_10.15 //

The `Āyogava`, the `Kṣattṛ`, and the `Caṇḍāla`, the lowest of men—these three base-born are produced in the reverse order from a Śūdra. // Mn_10.16 //

From a Vaiśya, the `Māgadha` and the `Vaideha`; and from a Kṣatriya, the `Sūta` alone. These are born in the reverse order; the others are also three base-born. // Mn_10.17 //

One born of a `Niṣāda` on a Śūdra woman becomes by caste a `Pukkasa`; but one born of a Śūdra on a `Niṣādī` woman is remembered as a `Kukkuṭaka`. // Mn_10.18 //
...
From a Brāhmaṇa `vrātya` is born a sinful-souled `Bhūrjakaṇṭaka`, and an `Āvantya`, a `Vāṭadhāna`, a `Puṣpadha`, and a `Śaikha`. // Mn_10.21 //

From a Kṣatriya `vrātya`, a `Jhalla`, a `Malla`, and a `Nicchivi`, and a `Naṭa`, a `Karaṇa`, a `Khasa`, and a `Draviḍa`. // Mn_10.22 //

But from a Vaiśya `vrātya` is born a `Sudhanvan` and an `Ācārya`, and a `Kāruṣa`, a `Vijanman`, a `Maitra`, and a `Sātvata`. // Mn_10.23 //
...
Just as a Śūdra begets an outsider creature on a Brāhmaṇa woman, so an outsider begets a still more outsider creature within the four-*varna* system. // Mn_10.30 //
...
The six sons born of one's own caste and of the next lower caste have the Dharma of the twice-born; but all those born of a degradation are remembered as having the same Dharma as Śūdras. // Mn_10.41 //
...
But by the gradual omission of sacred rites and by not seeing Brāhmaṇas, these Kṣatriya castes have sunk to the state of a Śūdra in the world. // Mn_10.43 //
...
Whatever castes in the world are outside those born from the mouth, arms, thighs, and feet, whether they speak the language of the `mlecchas` or of the Āryas, they are all remembered as barbarians. // Mn_10.45 //
...
A man who is outside the *varna* system, of unknown or impure origin, who is ignoble but has the appearance of an Ārya, one should discover by his own actions. // Mn_10.57 //
...
The unadorned giving up of one's body for the sake of a Brāhmaṇa or a cow, and in the protection of women and children, is a cause of perfection for the outsiders. // Mn_10.62 //
...
A son born of a Brāhmaṇa on a Śūdra woman, if he is born with excellence, the inferior attains the superior caste in the seventh generation. // Mn_10.64 //

A Śūdra attains the state of a Brāhmaṇa, and a Brāhmaṇa attains the state of a Śūdra; one should know it to be thus for one born of a Kṣatriya, and likewise for one born of a Vaiśya. // Mn_10.65 //

If a son is born by chance from a Brāhmaṇa on an ignoble woman, or from an ignoble man on a Brāhmaṇa woman, where is the superiority? If this should be asked: // Mn_10.66 //

One born of an Ārya on an ignoble woman may become an Ārya by his qualities; but one born of an ignoble man on an Ārya woman is ignoble; this is the decision. // Mn_10.67 //
...
And just as good seed, born in a good field, prospers, so one born of an Ārya on an Ārya woman is worthy of all the consecrating rites. // Mn_10.69 //
...
Having considered an ignoble man who performs Ārya deeds, and an Ārya who performs ignoble deeds, the Creator said, "They are not equal, nor are they unequal." // Mn_10.73 //

Those Brāhmaṇas who are established in the source of Brahma and who abide in their own duties, they should duly live by the six occupations in their proper order. // Mn_10.74 //
...
Three Dharmas cease for a Brāhmaṇa in relation to a Kṣatriya: teaching, sacrificing for others, and thirdly, accepting gifts. // Mn_10.77 //

In relation to a Vaiśya, these same ones cease; this is the established rule. For Manu Prajāpati did not declare those Dharmas for those two. // Mn_10.78 //

The bearing of arms and weapons for a Kṣatriya, and trade, cattle-herding, and agriculture for a Vaiśya; but for the sake of livelihood, their Dharma is giving, studying, and sacrificing. // Mn_10.79 //

The study of the Veda for a Brāhmaṇa, and the protection of subjects for a Kṣatriya, and the work of economics for a Vaiśya are the distinguished among their own duties. // Mn_10.80 //

But a Brāhmaṇa, unable to live by his own prescribed occupation, may live by the Dharma of a Kṣatriya; for that is the next to his. // Mn_10.81 //

But if it should be that he is unable to live even by both of these, how should it be? He may live by the livelihood of a Vaiśya, resorting to agriculture and cattle-herding. // Mn_10.82 //

But a Brāhmaṇa or even a Kṣatriya, even while living by the livelihood of a Vaiśya, should diligently avoid agriculture, which is largely dependent on violence and is dependent on others. // Mn_10.83 //
...
Water, weapons, poison, meat, Soma, and all perfumes; milk, honey, curds, ghee, oil, sweet syrup, molasses, and Kuśa grass. // Mn_10.88 //
...
By selling meat, lac, and salt, one falls immediately; by selling milk, a Brāhmaṇa becomes a Śūdra in three days. // Mn_10.92 //

But by the willful sale of other merchandise here, a Brāhmaṇa attains the state of a Vaiśya in seven nights. // Mn_10.93 //
...
A Kṣatriya, having fallen into distress, may live by all of this; but he should never think of a superior livelihood. // Mn_10.95 //
...
A Vaiśya, unable to live by his own Dharma, may even resort to the livelihood of a Śūdra; but he should refrain from forbidden acts and turn back when he is able. // Mn_10.98 //

But a Śūdra who is unable to perform the service of the twice-born, having reached a state where his wife and children are perishing, may live by the occupations of an artisan. // Mn_10.99 //

Those occupations of an artisan, and the various crafts, by the practice of which the twice-born are served. // Mn_10.100 //

A Brāhmaṇa who does not resort to the livelihood of a Vaiśya, but is established in his own path, being afflicted by a lack of livelihood and sinking, should follow this Dharma. // Mn_10.101 //

A Brāhmaṇa who has fallen into distress may accept gifts from anyone; that a pure thing is defiled—this is not supported by Dharma. // Mn_10.102 //

From teaching, or from sacrificing, or from accepting a condemned gift, no fault arises for Brāhmaṇas; for they are like fire and water. // Mn_10.103 //
...
And Vishvamitra, a discerner of Dharma and non-Dharma, being hungry, came to eat the hind-quarters of a dog, having taken it from the hand of a Caṇḍāla. // Mn_10.108 //

Of accepting gifts, of sacrificing, and likewise of teaching, accepting gifts is the most inferior; it is condemned for a Brāhmaṇa after death. // Mn_10.109 //

Sacrificing and teaching are always done for those of consecrated soul; but the acceptance of a gift is done even from a Śūdra, from one of the lowest birth. // Mn_10.110 //
...
A Brāhmaṇa who is unable to live may take up gleaning and picking up single grains from anywhere; gleaning is better than accepting gifts, and picking up single grains is praised even more than that. // Mn_10.112 //

By those who are sinking and who desire base metals or wealth, the lord of the earth // Mn_10.113 //

should be asked for by learned Brāhmaṇa *snātakas*; one who is unwilling to give deserves to be abandoned. // Mn_10.113 //
...
A Brāhmaṇa or a Kṣatriya should not lend at interest; but for a religious purpose, he may indeed, if he wishes, give a small amount to a sinful man. // Mn_10.117 //

A Kṣatriya who, in a time of distress, takes even a fourth part, while protecting his subjects to the best of his ability, is released from guilt. // Mn_10.118 //

His own Dharma is conquest; he must not be one who turns his back in battle. Having protected Vaiśyas with his weapon, he should collect a lawful tribute. // Mn_10.119 //

An eighth part of the grain is the tax for Vaiśyas, and a twentieth part on the lowest value of a *kārṣāpaṇa*; Śūdras, artisans, and craftsmen shall work. // Mn_10.120 //

But a Śūdra, desiring a livelihood, may serve a Kṣatriya; or a Śūdra, desiring to live, may serve a wealthy Vaiśya. // Mn_10.121 //

For the sake of heaven, or for the sake of both, he should serve Brāhmaṇas; for that is his fulfillment, he who has the name of 'born a Brāhmaṇa's servant'. // Mn_10.122 //

Service to Brāhmaṇas alone is declared to be the distinguished occupation of a Śūdra; for whatever else he does besides this becomes fruitless for him. // Mn_10.123 //
...
No sin causing loss of caste is incurred by a Śūdra, nor is he entitled to the consecrating rites; he has no right to the Dharma, nor is he forbidden from it. // Mn_10.126 //
...
Even if he is able, a Śūdra must not accumulate wealth; for a Śūdra, having acquired wealth, harasses Brāhmaṇas. // Mn_10.129 //
