...
The *sapiṇḍīkaraṇa* of women should be performed in the same way;
 And one should perform the *śrāddha* (ancestral rite) every year for as long as one lives. || Vi_21.22 ||

For him whose *sapiṇḍīkaraṇa* has been performed before the year is out,
