...
chapter_slug: 13
variant_id: "ac2c4204-096b-5827-9f17-ff77ecef8191"
...
The purpose of this chapter is to analyze society's "unconscious reasoning" which has led to the establishment of a color line--to the denial of social equality--wherever the white and black races have long been in contact during recent history; and to see whether this discrimination appears to be justified by eugenics.
...
As a result of the careful measurement of many skulls, Karl Pearson has come to the following conclusions:
...
This is what one would, *a priori*, probably expect. But it is on the "higher" mental functions that race progress largely depends, and the Negro must be judged eugenically mainly by his showing in these higher functions. One of the first studies in this line is that of M. J. Mayo, who summarizes it as follows:
...
A. C. Strong, using the Binet-Simon tests, found colored school children of Columbia, S. C., considerably less intelligent than white children.

W. H. Pyle made an extensive test of 408 colored pupils in Missouri public schools and compared them with white pupils. He concludes: "In general the marks indicating mental ability of the Negro are about two-thirds those of the whites.... In the substitution, controlled association, and Ebbinghaus tests, the Negroes are less than half as good as the whites. In free association and the ink-blot tests they are nearly as good. In quickness of perception and discrimination and in reaction, the Negroes equal or excel the whites."
