...
chapter_number: 23
chapter_title: "CHAPTER IX: the people (continued)"
chapter_slug: 23
variant_id: "524d3fae-de98-55cc-bd79-29b0fb15ec53"
...
Again, the State must assure itself a safe foundation, Edition: current; Page: [42] if it is to have stability, and to be able to resist the shocks it cannot help experiencing, as well as the efforts it will be forced to make for its maintenance; for all peoples have a kind of centrifugal force that makes them continually act one against another, and tend to aggrandise themselves at their neighbours’ expense, like the vortices of Descartes. Thus the weak run the risk of being soon swallowed up; and it is almost impossible for any one to preserve itself except by putting itself in a state of equilibrium with all, so that the pressure is on all sides practically equal.
