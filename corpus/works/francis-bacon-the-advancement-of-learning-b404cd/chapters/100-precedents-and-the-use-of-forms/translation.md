...
chapter_number: 100
chapter_title: Precedents and the use of forms
chapter_slug: "100-precedents-and-the-use-of-forms"
...
XXV. Let the limits of a precedent be observed, and Edition: current; Page: [401] rather kept within than exceeded; for where there is no rule of law, everything should be suspected: and therefore, as this is a dark road, we should not be hasty to follow.
...
XXXI. Examples are things of direction and advice, not rules or orders, and therefore should be so managed as to Edition: current; Page: [402] bend the authority of former times to the service of the present.
