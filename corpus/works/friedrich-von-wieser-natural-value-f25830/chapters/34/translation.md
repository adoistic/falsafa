...
chapter_number: 34
chapter_title: "CHAPTER XIII: the individual factors of imputation (continued). V. — the imputation to productive factors of preferable "
chapter_slug: 34
variant_id: "a77c6c91-dcba-568d-bed5-48b2b1fc074c"
...
Of two production goods of the same kind, that one possesses the better quality which shows the greater “rentability” —to use a clumsy but convenient German expression. In other Edition: current; Page: [112] words, it is that good which, when co-operating with the same amount of complementary goods, gives a return of higher value; —whether it be that the higher value of the return arises from more being produced, or from what is produced being of a better or preferable quality. In what follows, for brevity's sake, we shall consider only the former case.
