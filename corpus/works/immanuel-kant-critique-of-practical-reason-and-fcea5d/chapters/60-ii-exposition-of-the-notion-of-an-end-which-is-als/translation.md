...
chapter_slug: "60-ii-exposition-of-the-notion-of-an-end-which-is-als"
variant_id: "46f8ef8b-c5bf-5e61-b0d5-afa3d9aac86d"
...
Setting aside the question what sort of end that is which is in itself a duty, and how such an end is possible Edition: Rosenkranz; Page: [227], it is here only necessary to show that a duty of this kind is called a duty of virtue, and why it is so called.
...
The duty of virtue is essentially distinguished from the duty of justice in this respect; that it is morally possible to be externally compelled to the latter, whereas the former rests on free self-constraint only. For finite holy beings (which cannot even be tempted to the violation of duty) there is no doctrine of virtue, but only moral philosophy, the latter being an autonomy of practical reason, whereas the former is also an autocracy of it. Edition: current; Page: [294] That is, it includes a consciousness—not indeed immediately perceived, but rightly concluded from the moral categorical imperative—of the power to become master of one’s inclinations which resist the law; so that human morality in its highest stage can yet be nothing more than virtue; even if it were quite pure (perfectly free from the influence of a spring foreign to duty), Edition: Rosenkranz; Page: [228] a state which is poetically personified under the name of the wise man (as an ideal to which one should continually approximate).
