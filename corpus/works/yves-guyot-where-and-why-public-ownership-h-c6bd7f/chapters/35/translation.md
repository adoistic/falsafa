...
chapter_slug: 35
variant_id: "999b7ef8-c196-5ce1-86c8-4a9a5b99d821"
...
“In whatever manner we examine the statistics, the average number of victims of accidents resulting from traffic upon the old government system, the so-called model system, is noticeably higher than upon the private Edition: current; Page: [274] systems. The preceding period, that is to say, 1901–1905, gives precisely the same results. If we consider separately the number of the killed and injured, the results in the case of each of the above items are disadvantageous to the state.
...
“In all cases the advantage is with the French companies. It may be said positively that the safety of passengers is much greater upon the systems of the French Edition: current; Page: [276] companies than upon those of the French, Belgian, German, Austrian, Hungarian, or Swiss state lines. This conclusion is again borne out by the figures regarding accidents of all kinds per 100 km. operated. While the figure is 3.81 for the French private lines, it is 5.9 for Germany, 10.1 for Italy, 12.5 for Austria, and 50 for Switzerland.
...
The six greatest railway accidents that France has suffered during five years have thus all occurred on the government system: three on the Western, and three on the old government system, which the state has operated during nearly 35 years, and which has only Edition: current; Page: [278] 2,292 kilometers (1,433 miles), making the line about fifth in size of the important systems of France.
