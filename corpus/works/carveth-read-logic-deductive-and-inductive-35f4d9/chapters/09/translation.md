...
chapter_slug: 09
variant_id: "7e320df5-2f9a-51c1-88f7-f1e2a02263bb"
...
Thus stated (nearly as by Whately in the introduction to his *Logic*) the *Dictum* follows line by line the course of a Syllogism in the First Figure (see chap. X. § 2). To return to our former example: _All authors are vain* is the same as--Vanity is predicated of all authors; *Cicero is an author_ is the same as--Cicero is identified as an author; therefore *Cicero is vain*, or--Vanity may be predicated of Cicero. The *Dictum* then requires: (1) three propositions; (2) three terms; (3) that the middle term be distributed; (4) that one premise be affirmative, since only by an affirmative proposition can one term be identified with another; (5) that if one premise be negative the conclusion shall be so too, since whatever is predicated of the middle term is predicated *in like manner* of the minor.
...
Some cases, however, that at first seem obvious, are really delusive unless further data be supplied. Thus _A co-exists with B, B with C; .'. A with C*--is not sound unless *B_ is an instantaneous event; for where B is perdurable, *A* may co-exist with it at one time and *C* at another.
